...
<div class="widget-content">
   ...
   <p><label for="<?php echo $this->get_field_id('address'); ?>">:</label>
		<input class="widefat" id="<?php echo $this->get_field_id('address'); ?>" name="<?php echo $this->get_field_name('address'); ?>" type="text" value="<?php echo $address; ?>">
   </p>

   <p><label for="<?php echo $this->get_field_id('city'); ?>">:</label>
   ...
   <p><label for="<?php echo $this->get_field_id('province'); ?>">:</label>
   ...
   <p><label for="<?php echo $this->get_field_id('postal'); ?>">:</label>
   ...
   <p><label for="<?php echo $this->get_field_id('phone'); ?>">:</label>
		<input class="widefat" id="<?php echo $this->get_field_id('phone'); ?>" name="<?php echo $this->get_field_name('phone'); ?>" type="text" value="<?php echo $phone; ?>">
   </p>

   <p><label for="<?php echo $this->get_field_id('email'); ?>">:</label>
